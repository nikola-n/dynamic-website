...
//            $stmt->bindParam(':link_cover', $this->link_cover);
//            $stmt->bindParam(':title', $this->title);
//            $stmt->bindParam(':this->subtitle', $this->subtitle);
//            $stmt->bindParam(':about', $this->about);
//            $stmt->bindParam(':mobile', $this->mobile);
//            $stmt->bindParam(':location', $this->location);
//            $stmt->bindParam(':$this->before_contact', $this->before_contact);
//            $stmt->bindParam(':$this->service_product', $this->service_product);
//            $stmt->bindParam(':$this->social_id', $this->social_id);
//            $stmt->bindParam(':$this->pictures_id', $this->pictures_id);
//            $stmt->execute();
//            $this->id = $this->getConnection()->lastInsertId();
//
//            return $this->id;
